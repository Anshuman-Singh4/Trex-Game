...
return null},Vc=!1;if(G.querySelectorAll)try{var Wc=G.querySelectorAll(":root");Wc&&1==Wc.length&&Wc[0]==G.documentElement&&(Vc=!0)}catch(a){}var Sc=Vc;var kd={},ld=null,md=Math.random();kd.s="GTM-TZZBRK5";kd.Ob="561";kd.Ld="";var nd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},pd="www.googletagmanager.com/gtm.js";
var qd=pd,rd=null,sd=null,td=null,ud="//www.googletagmanager.com/a?id="+kd.s+"&cv=22",vd={},wd={},xd=function(){var a=ld.sequence||0;ld.sequence=a+1;return a};
...
f++}}return 0};var ok=!!F.MutationObserver,pk=void 0,qk=function(a){if(!pk){var b=function(){var c=G.body;if(c)if(ok)(new MutationObserver(function(){for(var e=0;e<pk.length;e++)I(pk[e])})).observe(c,{childList:!0,subtree:!0});else{var d=!1;nc(c,"DOMNodeInserted",function(){d||(d=!0,I(function(){d=!1;for(var e=0;e<pk.length;e++)I(pk[e])}))})}};pk=[];G.body?b():I(b)}pk.push(a)};
var Bk=function(){var a=G.body,b=G.documentElement||a&&a.parentElement,c,d;if(G.compatMode&&"BackCompat"!==G.compatMode)c=b?b.clientHeight:0,d=b?b.clientWidth:0;else{var e=function(f,h){return f&&h?Math.min(f,h):Math.max(f,h)};J("GTM",7);c=e(b?b.clientHeight:0,a?a.clientHeight:0);d=e(b?b.clientWidth:0,a?a.clientWidth:0)}return{width:d,height:c}},Ck=function(a){var b=Bk(),c=b.height,d=b.width,e=a.getBoundingClientRect(),f=e.bottom-e.top,h=e.right-e.left;return f&&h?(1-Math.min((Math.max(0-e.left,0)+
Math.max(e.right-d,0))/h,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0},Dk=function(a){if(G.hidden)return!0;var b=a.getBoundingClientRect();if(b.top==b.bottom||b.left==b.right||!F.getComputedStyle)return!0;var c=F.getComputedStyle(a,null);if("hidden"===c.visibility)return!0;for(var d=a,e=c;d;){if("none"===e.display)return!0;var f=e.opacity,h=e.filter;if(h){var k=h.indexOf("opacity(");0<=k&&(h=h.substring(k+8,h.indexOf(")",k)),"%"==h.charAt(h.length-1)&&(h=h.substring(0,h.length-
1)),f=Math.min(h,f))}if(void 0!==f&&0>=f)return!0;(d=d.parentElement)&&(e=F.getComputedStyle(d,null))}return!1};var Ek=[],Fk=!(!F.IntersectionObserver||!F.IntersectionObserverEntry),Gk=function(a,b,c){for(var d=new F.IntersectionObserver(a,{threshold:c}),e=0;e<b.length;e++)d.observe(b[e]);for(var f=0;f<Ek.length;f++)if(!Ek[f])return Ek[f]=d,f;return Ek.push(d)-1},Hk=function(a,b,c){function d(k,l){var m={top:0,bottom:0,right:0,left:0,width:0,
height:0},q={boundingClientRect:k.getBoundingClientRect(),intersectionRatio:l,intersectionRect:m,isIntersecting:0<l,rootBounds:m,target:k,time:Ea()};I(function(){return a(q)})}for(var e=[],f=[],h=0;h<b.length;h++)e.push(0),f.push(-1);c.sort(function(k,l){return k-l});return function(){for(var k=0;k<b.length;k++){var l=Ck(b[k]);if(l>e[k])for(;f[k]<c.length-1&&l>=c[f[k]+1];)d(b[k],l),f[k]++;else if(l<e[k])for(;0<=f[k]&&l<=c[f[k]];)d(b[k],l),f[k]--;e[k]=l}}},Ik=function(a,b,c){for(var d=0;d<c.length;d++)1<
c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(Fk){var e=!1;I(function(){e||Hk(a,b,c)()});return Gk(function(f){e=!0;for(var h={Xa:0};h.Xa<f.length;h={Xa:h.Xa},h.Xa++)I(function(k){return function(){return a(f[k.Xa])}}(h))},b,c)}return F.setInterval(Hk(a,b,c),1E3)},Jk=function(a){Fk?0<=a&&a<Ek.length&&Ek[a]&&(Ek[a].disconnect(),Ek[a]=void 0):F.clearInterval(a)};
var Kk=function(a,b,c){function d(){var h=a();f+=e?(Ea()-e)*h.playbackRate/1E3:0;e=Ea()}var e=0,f=0;return{Wb:function(h,k,l){var m=a(),q=m.oe,r=void 0!==l?Math.round(l):void 0!==k?Math.round(m.oe*k):Math.round(m.ng),u=void 0!==k?Math.round(100*k):0>=q?0:Math.round(r/q*100),p=G.hidden?!1:.5<=Ck(c);d();var t=ek(c,"gtm.video",[b]);t["gtm.videoProvider"]="youtube";t["gtm.videoStatus"]=h;t["gtm.videoUrl"]=m.url;t["gtm.videoTitle"]=m.title;t["gtm.videoDuration"]=Math.round(q);t["gtm.videoCurrentTime"]=
Math.round(r);t["gtm.videoElapsedTime"]=Math.round(f);t["gtm.videoPercent"]=u;t["gtm.videoVisible"]=p;Tj(t)},qh:function(){e=Ea()},Jc:function(){d()}}};var Lk=F.clearTimeout,Mk=F.setTimeout,S=function(a,b,c){if(eg()){b&&I(b)}else return jc(a,b,c)},Nk=function(){return F.location.href},Ok=function(a){return ne(pe(a),"fragment")},Pk=function(a){return oe(pe(a))},T=function(a,b){return Zd(a,b||2)},Qk=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=Tj(a)):d=Tj(a);return d},Rk=function(a,b){F[a]=b},V=function(a,b,c){b&&(void 0===F[a]||c&&!F[a])&&(F[a]=
...
Z.a.ytl=["google"],function(){function a(){var v=Math.round(1E9*Math.random())+"";return G.getElementById(v)?a():v}function b(v,y){if(!v)return!1;for(var x=0;x<u.length;x++)if(0<=v.indexOf("//"+u[x]+"/"+y))return!0;return!1}function c(v){var y=-1!==v.indexOf("?")?"&":"?";if(-1<v.indexOf("origin="))return v+y+"enablejsapi=1";if(!t){var x=V("document");t=x.location.protocol+"//"+x.location.hostname;x.location.port&&(t+=":"+x.location.port)}return v+y+"enablejsapi=1&origin="+encodeURIComponent(t)}function d(v,
y){var x=v.getAttribute("src");if(b(x,"embed/")){if(0<x.indexOf("enablejsapi=1"))return!0;if(y)return v.setAttribute("src",c(x)),!0}return!1}function e(v,y){if(!v.getAttribute("data-gtm-yt-inspected-"+y.qd)&&(v.setAttribute("data-gtm-yt-inspected-"+y.qd,"true"),d(v,y.ve))){v.id||(v.id=a());var x=V("YT"),B=x.get(v.id);B||(B=new x.Player(v.id));var A=h(B,y),z={},E;for(E in A)z.Ya=E,A.hasOwnProperty(z.Ya)&&B.addEventListener(z.Ya,function(H){return function(N){return A[H.Ya](N.data)}}(z)),z={Ya:z.Ya}}}
function f(v){I(function(){function y(){for(var B=x.getElementsByTagName("iframe"),A=B.length,z=0;z<A;z++)e(B[z],v)}var x=V("document");y();qk(y)})}function h(v,y){var x,B;function A(){U=Kk(function(){return{url:X,title:fa,oe:K,ng:v.getCurrentTime(),playbackRate:Y}},y.qd,v.getIframe());K=0;fa=X="";Y=1;return z}function z(O){switch(O){case p.PLAYING:K=Math.round(v.getDuration());X=v.getVideoUrl();if(v.getVideoData){var M=v.getVideoData();fa=M?M.title:""}Y=v.getPlaybackRate();y.gg?U.Wb("start"):U.Jc();
L=m(y.gh,y.fh,v.getDuration());return E(O);default:return z}}function E(){sa=v.getCurrentTime();ya=(new Date).getTime();U.qh();qa();return H}function H(O){var M;switch(O){case p.ENDED:return P(O);case p.PAUSED:M="pause";case p.BUFFERING:var Ga=v.getCurrentTime()-sa;M=1<Math.abs(((new Date).getTime()-ya)/1E3*Y-Ga)?"seek":M||"buffering";v.getCurrentTime()&&(y.fg?U.Wb(M):U.Jc());ba();return N;case p.UNSTARTED:return A(O);default:return H}}function N(O){switch(O){case p.ENDED:return P(O);case p.PLAYING:return E(O);
case p.UNSTARTED:return A(O);default:return N}}function P(){for(;B;){var O=x;Lk(B);O()}y.eg&&U.Wb("complete",1);return A(p.UNSTARTED)}function R(){}function ba(){B&&(Lk(B),B=0,x=R)}function qa(){if(L.length&&0!==Y){var O=-1,M;do{M=L[0];if(M.Ea>v.getDuration())return;O=(M.Ea-v.getCurrentTime())/Y;if(0>O&&(L.shift(),0===L.length))return}while(0>O);x=function(){B=0;x=R;0<L.length&&L[0].Ea===M.Ea&&(L.shift(),U.Wb("progress",M.Ne,M.Re));qa()};B=Mk(x,1E3*O)}}var U,L=[],K,X,fa,Y,sa,ya,Qb=A(p.UNSTARTED);
B=0;x=R;return{onStateChange:function(O){Qb=Qb(O)},onPlaybackRateChange:function(O){sa=v.getCurrentTime();ya=(new Date).getTime();U.Jc();Y=O;ba();qa()}}}function k(v){for(var y=v.split(","),x=y.length,B=[],A=0;A<x;A++){var z=parseInt(y[A],10);isNaN(z)||100<z||0>z||B.push(z/100)}B.sort(function(E,H){return E-H});return B}function l(v){for(var y=v.split(","),x=y.length,B=[],A=0;A<x;A++){var z=parseInt(y[A],10);isNaN(z)||0>z||B.push(z)}B.sort(function(E,H){return E-H});return B}function m(v,y,x){var B=
v.map(function(E){return{Ea:E,Re:E,Ne:void 0}});if(!y.length)return B;var A=y.map(function(E){return{Ea:E*x,Re:void 0,Ne:E}});if(!B.length)return A;var z=B.concat(A);z.sort(function(E,H){return E.Ea-H.Ea});return z}function q(v){v.vtp_triggerStartOption?r(v):Kg(function(){r(v)})}function r(v){var y=!!v.vtp_captureStart,x=!!v.vtp_captureComplete,B=!!v.vtp_capturePause,A=k(v.vtp_progressThresholdsPercent+""),z=l(v.vtp_progressThresholdsTimeInSeconds+""),E=!!v.vtp_fixMissingApi;if(y||x||B||A.length||
z.length){var H={gg:y,eg:x,fg:B,fh:A,gh:z,ve:E,qd:void 0===v.vtp_uniqueTriggerId?"":v.vtp_uniqueTriggerId},N=V("YT"),P=function(){f(H)};I(v.vtp_gtmOnSuccess);if(N)N.ready&&N.ready(P);else{var R=V("onYouTubeIframeAPIReady");Rk("onYouTubeIframeAPIReady",function(){R&&R();P()});I(function(){for(var ba=V("document"),qa=ba.getElementsByTagName("script"),U=qa.length,L=0;L<U;L++){var K=qa[L].getAttribute("src");if(b(K,"iframe_api")||b(K,"player_api"))return}for(var X=ba.getElementsByTagName("iframe"),fa=
X.length,Y=0;Y<fa;Y++)if(!w&&d(X[Y],H.ve)){S("https://www.youtube.com/iframe_api");w=!0;break}})}}else I(v.vtp_gtmOnSuccess)}var u=["www.youtube.com","www.youtube-nocookie.com"],p={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},t,w=!1;Z.__ytl=q;Z.__ytl.b="ytl";Z.__ytl.g=!0;Z.__ytl.priorityOverride=0}();
...
Z.a.evl=["google"],function(){function a(f,h){this.element=f;this.uid=h}function b(){var f=Number(T("gtm.start"))||0;return(new Date).getTime()-f}function c(f,h,k,l){function m(){if(!Dk(f.target)){h.has(e.Nb)||h.set(e.Nb,""+b());h.has(e.Dc)||h.set(e.Dc,""+b());var r=0;h.has(e.Pb)&&(r=Number(h.get(e.Pb)));r+=100;h.set(e.Pb,""+r);if(r>=k){var u=ek(f.target,"gtm.elementVisibility",[h.uid]),p=Ck(f.target);u["gtm.visibleRatio"]=Math.round(1E3*p)/10;u["gtm.visibleTime"]=k;u["gtm.visibleFirstTime"]=Number(h.get(e.Dc));
u["gtm.visibleLastTime"]=Number(h.get(e.Nb));Qk(u);l()}}}if(!h.has(e.fb)&&(0==k&&m(),!h.has(e.Ia))){var q=V("self").setInterval(m,100);h.set(e.fb,q)}}function d(f){f.has(e.fb)&&(V("self").clearInterval(Number(f.get(e.fb))),f.h(e.fb))}var e={fb:"polling-id-",Dc:"first-on-screen-",Nb:"recent-on-screen-",Pb:"total-visible-time-",Ia:"has-fired-"};a.prototype.has=function(f){return!!this.element.getAttribute("data-gtm-vis-"+f+this.uid)};a.prototype.get=function(f){return this.element.getAttribute("data-gtm-vis-"+
f+this.uid)};a.prototype.set=function(f,h){this.element.setAttribute("data-gtm-vis-"+f+this.uid,h)};a.prototype.h=function(f){this.element.removeAttribute("data-gtm-vis-"+f+this.uid)};(function(f){Z.__evl=f;Z.__evl.b="evl";Z.__evl.g=!0;Z.__evl.priorityOverride=0})(function(f){function h(){var y=!1,x=null;if("CSS"===l){try{x=Tc(m)}catch(H){}y=!!x&&w.length!=x.length}else if("ID"===l){var B=G.getElementById(m);B&&(x=[B],y=1!=w.length||w[0]!==B)}x||(x=[],y=0<w.length);if(y){for(var A=0;A<w.length;A++){var z=
new a(w[A],p);d(z)}w=[];for(var E=0;E<x.length;E++)w.push(x[E]);0<=v&&Jk(v);0<w.length&&(v=Ik(k,w,[u]))}}function k(y){var x=new a(y.target,p);y.intersectionRatio>=u?x.has(e.Ia)||c(y,x,r,"ONCE"===t?function(){for(var B=0;B<w.length;B++){var A=new a(w[B],p);A.set(e.Ia,"1");d(A)}Jk(v);if(q&&pk)for(var z=0;z<pk.length;z++)pk[z]===h&&pk.splice(z,1)}:function(){x.set(e.Ia,"1");d(x)}):(d(x),"MANY_PER_ELEMENT"===t&&x.has(e.Ia)&&(x.h(e.Ia),x.h(e.Pb)),x.h(e.Nb))}var l=f.vtp_selectorType,m;"ID"===l?m=String(f.vtp_elementId):
"CSS"===l&&(m=String(f.vtp_elementSelector));var q=!!f.vtp_useDomChangeListener,r=f.vtp_useOnScreenDuration&&Number(f.vtp_onScreenDuration)||0,u=(Number(f.vtp_onScreenRatio)||50)/100,p=f.vtp_uniqueTriggerId,t=f.vtp_firingFrequency,w=[],v=-1;h();q&&qk(h);I(f.vtp_gtmOnSuccess)})}();
