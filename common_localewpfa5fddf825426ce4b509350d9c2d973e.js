...
"abuseFormAcknowledge":function(d){return "By submitting this information, you acknowledge it will be handled in accordance with the terms of the [Privacy Policy]("+common_locale.v(d,"privacy_url")+") and the [Terms of Service]("+common_locale.v(d,"tos_url")+")."},
...
"abuseTypeQuestion":function(d){return "How does this content violate the [Terms of Service]("+common_locale.v(d,"url")+")?"},
...
"authorName":function(d){return "**Author:** "+common_locale.v(d,"name")},
"autoGenerated":function(d){return "Auto-generated"},
"autolock":function(d){return "Note: Stage auto-locks after 24 hours."},
"availableLessons":function(d){return " Available in "+common_locale.p(d,"numLessons",0,"en",{"one":"1 Lesson","other":common_locale.n(d,"numLessons")+" Lessons"})+":"},
...
"completedStudentPercent":function(d){return common_locale.v(d,"percentComplete")+"% of students completed"},
...
"contactUs":function(d){return "If you believe this to be an error, please [contact us]("+common_locale.v(d,"url")+")."},
...
"createStandardsReportSuggestion4":function(d){return "[Add a link to a student project]("+common_locale.v(d,"projectsLink")+")"},
...
"dataLibraryDescription":function(d){return "Find and import tables of real data from the Code.org library."},
...
"dataVisualizerFilterDescription":function(d){return "Filtered "+common_locale.v(d,"column")+" to "+common_locale.v(d,"value")},
...
"dataVisualizerSnapshotDescription":function(d){return "Created using Code.org App Lab on "+common_locale.v(d,"date")+" from the "+common_locale.v(d,"table")+" table in project "+common_locale.v(d,"project")},
...
"deleteAccount_personalLoginInstructions":function(d){return "Give these students a chance to keep using their Code.org accounts by [sending home instructions for creating personal logins.]("+common_locale.v(d,"explanationUrl")+") Give them at least a few days to follow these instructions BEFORE you delete your account."},
...
"errorParsingLibrary":function(d){return "There is an error in your imported library ("+common_locale.v(d,"libraryName")+"). Try deleting and re-importing this library. "+common_locale.v(d,"errorMessage")},
...
"exampleSolution":function(d){return "Example Solution "+common_locale.v(d,"number")},
...
"libraryCodeProfanity":function(d){return "It appears that your project contains inappropriate language. Please update your project to remove the "+common_locale.p(d,"profanityCount",0,"en",{"one":"word","other":"words"})+" \""+common_locale.v(d,"profaneWords")+"\"."},
...
"libraryDetailsProfanity":function(d){return "It appears your library name or description contains inappropriate language. Please update your name or description to remove the "+common_locale.p(d,"profanityCount",0,"en",{"one":"word","other":"words"})+" \""+common_locale.v(d,"profaneWords")+"\"."},
...
"loggedIn":function(d){return "Logged in: "+common_locale.v(d,"partner")},
"loginCardForPrint1":function(d){return "1.) Go to ["+common_locale.v(d,"directLink")+"]("+common_locale.v(d,"directLink")+") or to ["+common_locale.v(d,"joinLink")+"]("+common_locale.v(d,"joinLink")+") and type in your 6-letter section code: **"+common_locale.v(d,"sectionCode")+"**"},
"loginCardForPrint2":function(d){return "2.) Choose your name: **"+common_locale.v(d,"studentName")+"**"},
"loginCardForPrint3Picture":function(d){return "3.) Choose your secret picture:"},
"loginCardForPrint3Word":function(d){return "3.) Type in your secret words: **"+common_locale.v(d,"secretWords")+"**"},
"loginCardForPrint4":function(d){return "4.) Click the sign in button."},
"loginCardSectionName":function(d){return "Section name: **"+common_locale.v(d,"sectionName")+"**"},
...
"loginInfo_joinStep1":function(d){return "Create a Code.org account if they haven’t already done so. They can do this at "+common_locale.v(d,"url")+". Note that they can either sign up with an email address and password, or sign up through Google, Facebook, or Microsoft by clicking on one of these buttons:"},
...
"loginInfo_resetPasswordBody":function(d){return "If your student created a Code.org account using their email address and password (rather than signing in through Google, Facebook, Microsoft, or Clever), you can reset their password by going to the [Manage Students]("+common_locale.v(d,"url")+") tab of your section and clicking the \"Reset password\" button in the \"Password\" column."},
...
"mapsToCSTAStandards":function(d){return "Maps to [CSTA Standards]("+common_locale.v(d,"cstaLink")+")"},
...
"nameFailureDialogBody":function(d){return "It appears that your project name contains inappropriate language or personally identifiable information like your address, email, or phone number. Please pick a new name that doesn't contain \""+common_locale.v(d,"text")+".\""},
...
"partner":function(d){return "Partner: "+common_locale.v(d,"partner")},
...
"printReportWindowTitle":function(d){return "Standards Report for "+common_locale.v(d,"sectionName")},
...
"progressOnCSTAStandardsDescription":function(d){return "This view shows you how the lessons your class has completed map to the **[Computer Science Teachers Association's (CSTA) standards]("+common_locale.v(d,"cstaLink")+")**."},
...
"sharingDisabled":function(d){return "Sorry, this project is not available for sharing. If this is your project or the project of one of your students, please [sign in]("+common_locale.v(d,"sign_in_url")+") to your account to view the project."},
...
"standardsGetInvolvedDetails":function(d){return "Learn how to get your [administrators]("+common_locale.v(d,"adminLink")+"), [parents]("+common_locale.v(d,"parentLink")+"), and [fellow teachers]("+common_locale.v(d,"teacherLink")+") involved in CS education."},
"standardsGetInvolvedDetailsForPrint":function(d){return "Learn more about how you can support computer science education as an [administrator]("+common_locale.v(d,"adminLink")+"), [parent]("+common_locale.v(d,"parentLink")+"), or [teacher]("+common_locale.v(d,"teacherLink")+")."},
...
"syncingYourStudentsDescription":function(d){return "If your Code.org section is ever out of date with your list of students in "+common_locale.v(d,"loginType")+", click on the \"Sync students from "+common_locale.v(d,"loginType")+"\" button on the [Manage Students]("+common_locale.v(d,"url")+") tab: "},
...
"tosLong":function(d){return "This project has been reported for violating Code.org's [Terms of Service]("+common_locale.v(d,"url")+") and cannot be shared with others."},
...
"updateLibraryConfirmation":function(d){return "Are you sure you want to update "+common_locale.v(d,"libraryName")+"?"},
